...
lazy_static! {
    static ref IDT: InterruptDescriptorTable = {
        ...
        idt.vmm_communication_exception
            .set_handler_fn(vmm_comms_exception_handler);
...
#[allow(unused)]
extern "x86-interrupt" fn vmm_comms_exception_handler(_st_fr: InterruptStackFrame, code: u64) {
